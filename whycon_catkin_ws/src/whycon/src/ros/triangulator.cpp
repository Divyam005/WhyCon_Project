...
{
  points_left_sub.subscribe(n, "/whycon_left/points", 10);//declared subscriber
  points_right_sub.subscribe(n, "/whycon_right/points", 10);//declared subscriber

  poses_left_sub.subscribe(n, "/whycon_left/poses", 10);//declared subscriber
  poses_right_sub.subscribe(n, "/whycon_right/poses", 10);//declared subscriber
  ...
  viz_pub = n.advertise<visualization_msgs::Marker>("visualization_marker", 1);//declared publisher for marker_id
