...
# 77 "./src/main/drivers/serial.h" 3 4
   _Bool 
# 77 "./src/main/drivers/serial.h"
...
# 88 "./src/main/drivers/serial.h" 3 4
_Bool 
# 88 "./src/main/drivers/serial.h"
    isSerialTransmitBufferEmpty(serialPort_t *instance);
...
# 37 "./src/main/drivers/adc.h" 3 4
   _Bool 
# 37 "./src/main/drivers/adc.h"
        enabled;
    uint8_t sampleTime;
} adc_config_t;
...
# 42 "./src/main/drivers/adc.h" 3 4
   _Bool 
# 42 "./src/main/drivers/adc.h"
        enableVBat;
    
# 43 "./src/main/drivers/adc.h" 3 4
   _Bool 
# 43 "./src/main/drivers/adc.h"
        enableRSSI;
    
# 44 "./src/main/drivers/adc.h" 3 4
   _Bool 
# 44 "./src/main/drivers/adc.h"
        enableCurrentMeter;
    
# 45 "./src/main/drivers/adc.h" 3 4
   _Bool 
# 45 "./src/main/drivers/adc.h"
        enableExternal1;
} drv_adc_config_t;
...
# 105 "./src/main/io/serial.h" 3 4
_Bool 
# 105 "./src/main/io/serial.h"
    serialIsPortAvailable(serialPortIdentifier_e identifier);

# 106 "./src/main/io/serial.h" 3 4
_Bool 
# 106 "./src/main/io/serial.h"
...
# 113 "./src/main/io/serial.h" 3 4
_Bool 
# 113 "./src/main/io/serial.h"
...
# 165 "./src/main/rx/rx.h"
           rc_connected;
# 26 "./src/main/io/rc_controls.h" 2
...
# 39 "./src/main/drivers/pwm_rx.h" 3 4
_Bool 
# 39 "./src/main/drivers/pwm_rx.h"
...
# 44 "./src/main/drivers/pwm_rx.h" 3 4
_Bool 
# 44 "./src/main/drivers/pwm_rx.h"
...
# 24 "./src/main/rx/msp.h" 3 4
_Bool 
# 24 "./src/main/rx/msp.h"
...
# 26 "./src/main/rx/xbus.h" 3 4
_Bool 
# 26 "./src/main/rx/xbus.h"
    xBusInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
# 62 "./src/main/rx/rx.c" 3 4
_Bool 
# 62 "./src/main/rx/rx.c"
    sbusInit(rxConfig_t *initialRxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);

# 63 "./src/main/rx/rx.c" 3 4
_Bool 
# 63 "./src/main/rx/rx.c"
    spektrumInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);

# 64 "./src/main/rx/rx.c" 3 4
_Bool 
# 64 "./src/main/rx/rx.c"
    sumdInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);

# 65 "./src/main/rx/rx.c" 3 4
_Bool 
# 65 "./src/main/rx/rx.c"
    sumhInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback);
...
static 
# 132 "./src/main/rx/rx.c" 3 4
                  _Bool 
# 132 "./src/main/rx/rx.c"
...
static 
# 137 "./src/main/rx/rx.c" 3 4
                  _Bool 
# 137 "./src/main/rx/rx.c"
...
# 144 "./src/main/rx/rx.c" 3 4
                                                                    _Bool 
# 144 "./src/main/rx/rx.c"
                                                                         valid)
{
    if (channel < 4 && !valid) {
...
# 212 "./src/main/rx/rx.c" 3 4
   _Bool 
# 212 "./src/main/rx/rx.c"
        enabled = 
# 212 "./src/main/rx/rx.c" 3 4
                  0
# 212 "./src/main/rx/rx.c"
...
# 284 "./src/main/rx/rx.c" 3 4
_Bool 
# 284 "./src/main/rx/rx.c"
    rxIsReceivingSignal(void)
{
...
# 289 "./src/main/rx/rx.c" 3 4
_Bool 
# 289 "./src/main/rx/rx.c"
    rxAreFlightChannelsValid(void)
{
    return rxFlightChannelsValid;
}
static 
# 293 "./src/main/rx/rx.c" 3 4
      _Bool 
# 293 "./src/main/rx/rx.c"
           isRxDataDriven(void) {
...
static void resetRxSignalReceivedFlagIfNeeded(uint32_t currentTime)
{
    ...
    if (((int32_t)(currentTime - needRxSignalBefore) >= 0)) {
        rxSignalReceived = 
# 304 "./src/main/rx/rx.c" 3 4
                          0
# 304 "./src/main/rx/rx.c"
                               ;
        rxSignalReceivedNotDataDriven = 
# 305 "./src/main/rx/rx.c" 3 4
                                       0
# 305 "./src/main/rx/rx.c"
                                            ;
    }
}
...
void updateRx(uint32_t currentTime)
{
    ...
    if (isRxDataDriven()) {
        rxDataReceived = 
# 328 "./src/main/rx/rx.c" 3 4
                        0
# 328 "./src/main/rx/rx.c"
                             ;
    }
 rc_connected = rxSignalReceived;
    ...
    if (feature(FEATURE_RX_SERIAL)) {
        ...
        if (frameStatus & SERIAL_RX_FRAME_COMPLETE) {
            rxDataReceived = 
# 338 "./src/main/rx/rx.c" 3 4
                            1
# 338 "./src/main/rx/rx.c"
                                ;
    ...
    if (feature(FEATURE_RX_MSP)) {
        ...
        if (rxDataReceived) {
            rxSignalReceived = 
# 350 "./src/main/rx/rx.c" 3 4
                              1
# 350 "./src/main/rx/rx.c"
                                  ;
            rxIsInFailsafeMode = 
...
# 375 "./src/main/rx/rx.c" 3 4
_Bool 
# 375 "./src/main/rx/rx.c"
    shouldProcessRx(uint32_t currentTime)
{
...
static uint16_t calculateNonDataDrivenChannel(uint8_t chan, uint16_t sample)
{
    ...
    static 
# 384 "./src/main/rx/rx.c" 3 4
          _Bool 
# 384 "./src/main/rx/rx.c"
               rxSamplesCollected = 
# 384 "./src/main/rx/rx.c" 3 4
                                    0
# 384 "./src/main/rx/rx.c"
...
# 475 "./src/main/rx/rx.c" 3 4
   _Bool 
# 475 "./src/main/rx/rx.c"
        useValueFromRx = 
# 475 "./src/main/rx/rx.c" 3 4
                         1
# 475 "./src/main/rx/rx.c"
...
# 476 "./src/main/rx/rx.c" 3 4
   _Bool 
# 476 "./src/main/rx/rx.c"
    ...
    if (!rxSignalReceived || rxIsInFailsafeMode) {
        useValueFromRx = 
# 485 "./src/main/rx/rx.c" 3 4
                        0
# 485 "./src/main/rx/rx.c"
                             ;
    }
...
# 500 "./src/main/rx/rx.c" 3 4
       _Bool 
# 500 "./src/main/rx/rx.c"
    ...
    if ((rxFlightChannelsValid) && !((1 << (BOXFAILSAFE)) & rcModeActivationMask)) {
        ...
        rxIsInFailsafeMode = rxIsInFailsafeModeNotDataDriven = 
# 531 "./src/main/rx/rx.c" 3 4
                                                              1
# 531 "./src/main/rx/rx.c"
                                                                  ;
