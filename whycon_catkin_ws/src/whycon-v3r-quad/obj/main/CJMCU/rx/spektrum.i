...
# 30 "./src/main/drivers/serial_uart.h"
...
# 63 "./src/main/drivers/serial_uart.h" 3 4
_Bool 
# 63 "./src/main/drivers/serial_uart.h"
...
static 
# 51 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 51 "./src/main/rx/spektrum.c"
           rcFrameComplete = 
# 51 "./src/main/rx/spektrum.c" 3 4
                             0
# 51 "./src/main/rx/spektrum.c"
                                  ;
static 
# 52 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 52 "./src/main/rx/spektrum.c"
           spekHiRes = 
# 52 "./src/main/rx/spektrum.c" 3 4
                       0
# 52 "./src/main/rx/spektrum.c"
...
# 61 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 61 "./src/main/rx/spektrum.c"
    spektrumInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    switch (rxConfig->serialrx_provider) {
        case SERIALRX_SPEKTRUM2048:
            ...
            spek_chan_mask = 0x07;
            spekHiRes = 
# 70 "./src/main/rx/spektrum.c" 3 4
                       1
# 70 "./src/main/rx/spektrum.c"
                           ;
        ...
        case SERIALRX_SPEKTRUM1024:
            ...
            spek_chan_mask = 0x03;
            spekHiRes = 
# 77 "./src/main/rx/spektrum.c" 3 4
                       0
# 77 "./src/main/rx/spektrum.c"
                            ;
    ...
    if (!portConfig) {
        return 
# 87 "./src/main/rx/spektrum.c" 3 4
              0
# 87 "./src/main/rx/spektrum.c"
                   ;
    }
    ...
    return spektrumPort != 
# 92 "./src/main/rx/spektrum.c" 3 4
                          ((void *)0)
# 92 "./src/main/rx/spektrum.c"
                              ;
}
...
static void spektrumDataReceive(uint16_t c)
{
    ...
    if (spekFramePosition == 16 - 1) {
        rcFrameComplete = 
# 111 "./src/main/rx/spektrum.c" 3 4
                         1
# 111 "./src/main/rx/spektrum.c"
                             ;
    } else {
        spekFramePosition++;
    }
...
uint8_t spektrumFrameStatus(void)
{
    ...
    rcFrameComplete = 
# 127 "./src/main/rx/spektrum.c" 3 4
                     0
# 127 "./src/main/rx/spektrum.c"
                          ;
...
# 157 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 157 "./src/main/rx/spektrum.c"
