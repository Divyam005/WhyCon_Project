...
static 
# 75 "./src/main/rx/sbus.c" 3 4
      _Bool 
# 75 "./src/main/rx/sbus.c"
           sbusFrameDone = 
# 75 "./src/main/rx/sbus.c" 3 4
                           0
# 75 "./src/main/rx/sbus.c"
...
# 81 "./src/main/rx/sbus.c" 3 4
_Bool 
# 81 "./src/main/rx/sbus.c"
    sbusInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    int b;
    for (b = 0; b < 18; b++)
    ...
    if (!portConfig) {
        return 
# 92 "./src/main/rx/sbus.c" 3 4
              0
# 92 "./src/main/rx/sbus.c"
                   ;
    }

    serialPort_t *sBusPort = openSerialPort(portConfig->identifier, FUNCTION_RX_SERIAL, sbusDataReceive, 100000, MODE_RX, (portOptions_t)(SERIAL_STOPBITS_2 | SERIAL_PARITY_EVEN | SERIAL_INVERTED));

    return sBusPort != 
# 97 "./src/main/rx/sbus.c" 3 4
                      ((void *)0)
# 97 "./src/main/rx/sbus.c"
                          ;
}
...
# 168 "./src/main/rx/sbus.c"
        ...
        sbusFrameDone = 
# 173 "./src/main/rx/sbus.c" 3 4
                       0
# 173 "./src/main/rx/sbus.c"
                            ;
    }
}
