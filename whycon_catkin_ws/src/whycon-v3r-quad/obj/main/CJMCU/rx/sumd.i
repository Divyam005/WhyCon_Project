...
static 
# 45 "./src/main/rx/sumd.c" 3 4
      _Bool 
# 45 "./src/main/rx/sumd.c"
           sumdFrameDone = 
# 45 "./src/main/rx/sumd.c" 3 4
                           0
# 45 "./src/main/rx/sumd.c"
...
# 52 "./src/main/rx/sumd.c" 3 4
_Bool 
# 52 "./src/main/rx/sumd.c"
    sumdInit(rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig, rcReadRawDataPtr *callback)
{
    ...
    if (!portConfig) {
        return 
# 63 "./src/main/rx/sumd.c" 3 4
              0
# 63 "./src/main/rx/sumd.c"
                   ;
    }
    ...
    return sumdPort != 
# 68 "./src/main/rx/sumd.c" 3 4
                      ((void *)0)
# 68 "./src/main/rx/sumd.c"
                          ;
}
...
# 107 "./src/main/rx/sumd.c"
    ...
    if (sumdIndex < sumdChannelCount * 2 + 4)
        ...
        if (sumdIndex == sumdChannelCount * 2 + 5) {
            sumdIndex = 0;
            sumdFrameDone = 
# 121 "./src/main/rx/sumd.c" 3 4
                           1
# 121 "./src/main/rx/sumd.c"
                               ;
        }
}
...
uint8_t sumdFrameStatus(void)
{
    ...
    sumdFrameDone = 
# 143 "./src/main/rx/sumd.c" 3 4
                   0
# 143 "./src/main/rx/sumd.c"
                        ;
