# 1 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
...
#define __REVISION__ ""
# 1 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
# 29 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
...
# 1939 "./lib/main/VL53L0X_API/core/inc/vl53l0x_api.h"
 ...
 uint32_t *refSpadCount, uint8_t *isApertureSpads);
# 30 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c" 2
...
# 31 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c" 2
# 1 "./lib/main/VL53L0X_API/core/inc/vl53l0x_api_calibration.h" 1
# 30 "./lib/main/VL53L0X_API/core/inc/vl53l0x_api_calibration.h"
#define _VL53L0X_API_CALIBRATION_H_ 
# 40 "./lib/main/VL53L0X_API/core/inc/vl53l0x_api_calibration.h"
...
VL53L0X_Error VL53L0X_get_ref_calibration(VL53L0X_DEV Dev,
  uint8_t *pVhvSettings, uint8_t *pPhaseCal);
# 32 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c" 2
# 44 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
#define REF_ARRAY_SPAD_0 0
#define REF_ARRAY_SPAD_5 5
#define REF_ARRAY_SPAD_10 10

uint32_t refArrayQuadrants[4] = {10, 5,
  0, 5 };
...
# 135 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
   ...
   int32_t *pOffsetMicroMeter)
{
 ...
 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_GetSequenceStepEnable(Dev,
    ((VL53L0X_VcselPeriod) 0), &SequenceStepEnabled);
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  ...
  if (Status == ((VL53L0X_Error) 0)) {
   (Dev->Data.CurrentParameters.RangeOffsetMicroMeters)=(*pOffsetMicroMeter)
                        ;
...
VL53L0X_Error VL53L0X_apply_offset_adjustment(VL53L0X_DEV Dev)
{
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  ...
  (Dev->Data.Part2PartOffsetNVMMicroMeter)=(CurrentOffsetMicroMeters)
                            ;

  CorrectedOffsetMicroMeters = CurrentOffsetMicroMeters +
   (int32_t)(Dev->Data.Part2PartOffsetAdjustmentNVMMicroMeter)
                                           ;
  ...
  if (Status == ((VL53L0X_Error) 0)) {
   (Dev->Data.CurrentParameters.RangeOffsetMicroMeters)=(CorrectedOffsetMicroMeters)
                                ;
  }
 }
   ...
   uint32_t curr, int32_t *next)
{
 ...
 uint8_t dataByte;
 uint8_t success = 0;
# 417 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
 *next = -1;
...
uint8_t is_aperture(uint32_t spadIndex)
{
 ...
 if (refArrayQuadrants[quadrant] == 0)
  isAperture = 0;
...
# 583 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
 currentSpad = offset;
  ...
  uint16_t *refSignalRate)
{
 ...
 if (status == ((VL53L0X_Error) 0)) {
  ...
  status = VL53L0X_WrByte(Dev, 0x0001,
    SequenceConfig);
  if (status == ((VL53L0X_Error) 0))
...
# 724 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
 targetRefRate = (Dev->Data.targetRefRate);
# 734 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
  ...
  *isApertureSpads = isApertureSpads_int;
  ...
  (Dev->Data.DeviceSpecificParameters.ReferenceSpadCount)=((uint8_t)(*refSpadCount))
                                                ;
     ...
     uint32_t count, uint8_t isApertureSpads)
{
 ...
 uint32_t index;
# 961 "./lib/main/VL53L0X_API/core/src/vl53l0x_api_calibration.c"
 Status = VL53L0X_WrByte(Dev, 0xFF, 0x01);
 ...
 if (Status == ((VL53L0X_Error) 0)) {
  (Dev->Data.DeviceSpecificParameters.RefSpadsInitialised)=(1);
  (Dev->Data.DeviceSpecificParameters.ReferenceSpadCount)=((uint8_t)(count))
                                        ;
  (Dev->Data.DeviceSpecificParameters.ReferenceSpadType)=(isApertureSpads)
                                      ;
 }
   ...
   uint32_t *pSpadCount, uint8_t *pIsApertureSpads)
{
  ...
  *pSpadCount = (uint32_t)(Dev->Data.DeviceSpecificParameters).ReferenceSpadCount
                      ;
  *pIsApertureSpads = (Dev->Data.DeviceSpecificParameters).ReferenceSpadType
                     ;
 } else {
  ...
  if (Status == ((VL53L0X_Error) 0)) {
    ...
    *pIsApertureSpads = isApertureSpads;
    ...
    (Dev->Data.DeviceSpecificParameters.RefSpadsInitialised)=(1)
                            ;
    (Dev->Data.DeviceSpecificParameters.ReferenceSpadCount)=((uint8_t)spadsEnabled)
  ...
  uint8_t vhv_init_byte)
{
 ...
 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_WrByte(Dev, 0x000, 0x00);
 ...
 const uint8_t restore_config)
{
 ...
 Status = VL53L0X_WrByte(Dev, 0x0001, 0x01);

 if (Status == ((VL53L0X_Error) 0))
  Status = VL53L0X_perform_single_ref_calibration(Dev, 0x40);


 if ((Status == ((VL53L0X_Error) 0)) && (get_data_enable == 1)) {
 ...
 if ((Status == ((VL53L0X_Error) 0)) && restore_config) {
 ...
 const uint8_t restore_config)
{
 ...
 Status = VL53L0X_WrByte(Dev, 0x0001, 0x02);
