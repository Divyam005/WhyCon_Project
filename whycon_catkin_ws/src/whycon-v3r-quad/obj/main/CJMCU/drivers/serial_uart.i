...
{
    uartPort_t *s = 
# 99 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 99 "./src/main/drivers/serial_uart.c"
                       ;
...
void uartStartTxDMA(uartPort_t *s)
{
    ...
    s->txDMAEmpty = 
# 210 "./src/main/drivers/serial_uart.c" 3 4
                   0
# 210 "./src/main/drivers/serial_uart.c"
                        ;
...
# 268 "./src/main/drivers/serial_uart.c" 3 4
_Bool 
# 268 "./src/main/drivers/serial_uart.c"
