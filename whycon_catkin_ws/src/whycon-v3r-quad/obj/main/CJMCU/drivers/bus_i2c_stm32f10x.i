...
# 61 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                          ((void *)0)
# 61 "./src/main/drivers/bus_i2c_stm32f10x.c"
                              ;
...
static volatile 
# 88 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
               _Bool 
# 88 "./src/main/drivers/bus_i2c_stm32f10x.c"
                    error = 
# 88 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                            0
# 88 "./src/main/drivers/bus_i2c_stm32f10x.c"
                                 ;
static volatile 
# 89 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
               _Bool 
# 89 "./src/main/drivers/bus_i2c_stm32f10x.c"
                    busy;
...
static 
# 99 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 99 "./src/main/drivers/bus_i2c_stm32f10x.c"
           i2cHandleHardwareFailure(void)
{
    i2cErrorCount++;

    i2cInit(I2Cx_index);
    return 
# 104 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          0
# 104 "./src/main/drivers/bus_i2c_stm32f10x.c"
               ;
}


# 107 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 107 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    ...
    busy = 1;
    error = 
# 119 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
           0
# 119 "./src/main/drivers/bus_i2c_stm32f10x.c"
                ;

    if (!I2Cx)
        return 
# 122 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 122 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
...
# 144 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 144 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWrite(uint8_t addr_, uint8_t reg_, uint8_t data)
{
    return i2cWriteBuffer(addr_, reg_, 1, &data);
}


# 149 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 149 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cRead(uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    uint32_t timeout = 30000;
...
static void i2c_er_handler(void)
{
    ...
    if (SR1Register & 0x0F00) {
        error = 
# 190 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
               1
# 190 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
