...
# 32 "./src/main/drivers/bus_spi.h" 3 4
_Bool 
# 32 "./src/main/drivers/bus_spi.h"
...
# 250 "./src/main/drivers/bus_spi.c"

# 250 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 250 "./src/main/drivers/bus_spi.c"
    spiInit(SPI_TypeDef *instance)
{
    ...
    (void)(instance);
# 268 "./src/main/drivers/bus_spi.c"
    return 
# 268 "./src/main/drivers/bus_spi.c" 3 4
          0
# 268 "./src/main/drivers/bus_spi.c"
               ;
}
    ...
    spiTransfer(SPI_TypeDef *instance, uint8_t *out, const uint8_t *in, int len)
{
    ...
    return 
# 349 "./src/main/drivers/bus_spi.c" 3 4
          1
# 349 "./src/main/drivers/bus_spi.c"
              ;
}
