...
int main(void) {
	...
	// Perforamce test basic trajectory *
	cmd = {TAKE_OFF,0,50,100};
	command_def(&cmd);
	cmd = {SLEEP,2,0,0};
	command_def(&cmd);
	cmd = {GO_TO_WAY_POINT,0,-50,70};
	command_def(&cmd);
	cmd = {SLEEP,1,0,0};
    command_def(&cmd);
    cmd = {LAND,0,-50,0};
   	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,-40,120};
//	command_def(&cmd);

	/**/
	
	/* 3 Steps trajectory */
//	cmd = {TAKE_OFF,0,80,110};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,40,110};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,40,80};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,0,80};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,0,50};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,-40,50};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {GO_TO_WAY_POINT,0,0,150};
//	command_def(&cmd);
//	cmd = {SLEEP,1,0,0};
//	command_def(&cmd);
//	cmd = {LAND,0,-40,0};
