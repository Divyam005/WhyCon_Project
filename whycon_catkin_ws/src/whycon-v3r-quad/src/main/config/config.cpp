...
static void resetPidProfile(pidProfile_t *pidProfile)
{
    ...
    pidProfile->P8[PIDALT] = 200;
    pidProfile->I8[PIDALT] = 0;
    pidProfile->D8[PIDALT] = 30; //0;
    pidProfile->P8[PIDPOS] = 40; // POSHOLD_P * 100;
    pidProfile->I8[PIDPOS] = 0; // POSHOLD_I * 100;
    pidProfile->D8[PIDPOS] = 0;
    pidProfile->P8[PIDPOSR] = 40; // POSHOLD_RATE_P * 10;
    pidProfile->I8[PIDPOSR] = 2; // POSHOLD_RATE_I * 100;
    pidProfile->D8[PIDPOSR] = 4; // POSHOLD_RATE_D * 1000;
    pidProfile->P8[PIDNAVR] = 9; // NAV_P * 10;
    pidProfile->I8[PIDNAVR] = 5; // NAV_I * 100;
    pidProfile->D8[PIDNAVR] = 12; // NAV_D * 1000;
...
static void resetControlRateConfig(controlRateConfig_t *controlRateConfig) {
    ...
    /* Drona Aviation */
    controlRateConfig->rates[FD_PITCH] = 70;
    //controlRateConfig->rates[FD_ROLL] = 75;
}

void resetRcControlsConfig(rcControlsConfig_t *rcControlsConfig) {
    rcControlsConfig->deadband = 0;
    rcControlsConfig->yaw_deadband = 80;
