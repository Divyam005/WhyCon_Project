...
//Drona Aviation
//uint16_t flightIndicatorFlag=(1<<0);
uint16_t flightIndicatorFlag=0;
static uint32_t enabledSensors = 0;
bool rc_connected;  //DD
/**
...
bool status_FSI(FlightStatus_f flag){
...
{
	int32_t LedTime;
    static int delay_time=100;   //reduce this to make led blink faster         //changes made by DD
