...
void GamepadInstance::Paint() {
  ...
  /*  //generic gamepad
  int a = static_cast<int>((pad.axes[0] *500)+1500);
  int b = static_cast<int>((-(pad.axes[ 1] )* 500)+1500);
  int c = static_cast<int>((pad.axes[ 2] * 500)+1500);
  int d = static_cast<int>((-(pad.axes[ 5]) * 500)+1500);
...
pp::VarArray array;
    ...
    array.Set(2, b);
    array.Set(3, a);
    array.Set(4, pad.buttons[4]);
    array.Set(5, pad.buttons[5]);
    array.Set(6, pad.buttons[6]);
    array.Set(7, pad.buttons[7]);
...
//X3D joystick
 int a = static_cast<int>((pad.axes[0] *500)+1500);
  int b = static_cast<int>((-(pad.axes[ 1] )* 500)+1500);
  int c = static_cast<int>((-(pad.axes[ 6] )* 500)+1500);
  int d = static_cast<int>(((pad.axes[ 5]) * 500)+1500);
...
*/
  ...
  int b = static_cast<int>((-(pad.axes[ 1] )* 500)+1500);
  int c = static_cast<int>((pad.axes[ 2] * 500)+1500);
  int d = static_cast<int>((-(pad.axes[ 3]) * 500)+1500);
  int e = static_cast<int>((pad.axes[4] *500)+1500);
  int f = static_cast<int>((-(pad.axes[ 5] )* 500)+1500);
  int g = static_cast<int>((pad.axes[ 6] * 500)+1500);
  int h = static_cast<int>((-(pad.axes[ 7]) * 500)+1500);
  int i = static_cast<int>((pad.axes[8] *500)+1500);
  int j = static_cast<int>((pad.axes[ 9] * 500)+1500);
  int k = static_cast<int>((pad.axes[ 10] * 500)+1500);
  ...
  pp::VarArray array;
    ...
    array.Set(9, j);
    array.Set(10, k); 
    array.Set(11, pad.buttons[0]);
    array.Set(12, pad.buttons[1]);
    array.Set(13, pad.buttons[2]);
    array.Set(14, pad.buttons[3]);
    array.Set(15, pad.buttons[4]);
    array.Set(16, pad.buttons[5]);
    array.Set(17, pad.buttons[6]);
    array.Set(18, pad.buttons[7]);
    array.Set(19, pad.buttons[8]);
    array.Set(20, pad.buttons[9]);
    array.Set(21, pad.buttons[10]);
    array.Set(22, pad.buttons[11]);
